...
add_library(ClassMngrEngine STATIC
    ...
    "${PROJECT_SOURCE_DIR}/src/engine/platform_services.cpp"
    "${PROJECT_SOURCE_DIR}/src/engine/include/classmngr/engine/platform_services.h"
    "${PROJECT_SOURCE_DIR}/src/engine/resource_pack_policy.cpp"
...
if(BUILD_TESTING)
    ...
    add_executable(ClassMngrEngineScheduleWorkbookReaderContractTests
        "${PROJECT_SOURCE_DIR}/tests/engine/schedule_workbook_reader_contract_tests.cpp"
    )
    target_link_libraries(ClassMngrEngineScheduleWorkbookReaderContractTests
        PRIVATE
            ClassMngrEngine
            ClassMngrCommonBuildSettings
    )
    set_target_properties(ClassMngrEngineScheduleWorkbookReaderContractTests
        PROPERTIES
            CXX_EXTENSIONS OFF
    )
    add_test(
    ...
    add_executable(ClassMngrEngineResourcePackPolicyTests
        "${PROJECT_SOURCE_DIR}/tests/engine/resource_pack_policy_tests.cpp"
    )
    target_link_libraries(ClassMngrEngineResourcePackPolicyTests
        PRIVATE
            ClassMngrEngine
            ClassMngrCommonBuildSettings
    )
    set_target_properties(ClassMngrEngineResourcePackPolicyTests
        PROPERTIES
            CXX_EXTENSIONS OFF
    )
    add_test(
        NAME ClassMngrEngineResourcePackPolicyTests
        COMMAND ClassMngrEngineResourcePackPolicyTests
    )

    add_executable(ClassMngrEnginePlatformServicesTests
        "${PROJECT_SOURCE_DIR}/tests/engine/platform_services_tests.cpp"
    )
    target_link_libraries(ClassMngrEnginePlatformServicesTests
        PRIVATE
            ClassMngrEngine
            ClassMngrCommonBuildSettings
    )
    set_target_properties(ClassMngrEnginePlatformServicesTests
        PROPERTIES
            CXX_EXTENSIONS OFF
    )
    add_test(
        NAME ClassMngrEnginePlatformServicesTests
        COMMAND ClassMngrEnginePlatformServicesTests
    )
