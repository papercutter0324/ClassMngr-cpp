...
Invoke-StageSmokeTest `
    -Executable $executablePath `
    -WorkingDirectory $stagePath `
    -Argument '--phase5-campus-test'
Invoke-StageSmokeTest `
    -Executable $executablePath `
    -WorkingDirectory $stagePath `
    -Argument '--phase6-personal-details-test'
Invoke-StageSmokeTest `
    -Executable $executablePath `
    -WorkingDirectory $stagePath `
...
Invoke-StageSmokeTest `
    -Executable $executablePath `
    -WorkingDirectory $stagePath `
    -Argument '--phase6-gs-team-test'
Invoke-StageSmokeTest `
    -Executable $executablePath `
    -WorkingDirectory $stagePath `
    -Argument '--phase6-class-information-test'
Invoke-StageSmokeTest `
    -Executable $executablePath `
    -WorkingDirectory $stagePath `
    -Argument '--phase6-calendar-test'
Invoke-StageSmokeTest `
    -Executable $executablePath `
    -WorkingDirectory $stagePath `
    -Argument '--phase6-roster-test'
Invoke-StageSmokeTest `
    -Executable $executablePath `
    -WorkingDirectory $stagePath `
    -Argument '--phase6-schedule-test'
Invoke-StageSmokeTest `
    -Executable $executablePath `
    -WorkingDirectory $stagePath `
    -Argument '--phase6-speaking-evaluation-test'
