#include "sub_prep_class_navigation.h"
...
struct TabCandidate
{
    SubPrepClassNavigation::ClassTab tab;
    QString baseLabel;
...
QString gradeKey(
    const SubPrepClassNavigation::ClassEntry& entry
    )
{
    const QString grade =
        entry.grade.trimmed();
...
bool entryLessThan(
    const SubPrepClassNavigation::ClassEntry& left,
    const SubPrepClassNavigation::ClassEntry& right
    )
{
...
QList<SubPrepClassNavigation::ClassEntry> sortedEntries(
    const QList<SubPrepClassNavigation::ClassEntry>& entries
    )
{
    QList<SubPrepClassNavigation::ClassEntry> result =
        entries;
...
QList<SubPrepClassNavigation::ClassTab> makeClassTabs(
    const QList<SubPrepClassNavigation::ClassEntry>& entries,
    bool includeGrade
    )
{
    ...
    for (const SubPrepClassNavigation::ClassEntry& entry : entries)
    {
        TabCandidate candidate;
    ...
    QList<SubPrepClassNavigation::ClassTab> tabs;
