...
// Qt-boundary adapter for the read-only personal display name. The exact
// legacy key and QVariant-to-UTF-8 conversion stay here; personal-details
// writers remain compatibility owners.
