...
- Large schedule-import apply/commit cleanup and a large calendar
  workbook/import lifecycle; the retained schedule-import artifact currently
  covers parse, review, conflict acknowledgement, cancellation, and cleanup.
  The class-transfer conflict and compact schedule-workbook review fixtures are
  now permanent.
