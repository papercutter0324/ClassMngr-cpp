...
ClassTabNavigation::ClassEntry classEntry(
    int classId,
    const QString& grade,
    const QString& level,
...
void ClassTabNavigationTests::sixOrFewerClassesUseFlatTabs()
{
    ...
    QCOMPARE(
        ...
        static_cast<int>(ClassTabNavigation::Mode::Flat)
        );
...
void ClassTabNavigationTests::forcedGroupingUsesGradeAndLevelRows()
{
    const QList<ClassTabNavigation::ClassEntry> entries{
        classEntry(
            1,
    ...
    QCOMPARE(model.mode, ClassTabNavigation::Mode::GradeGrouped);
...
void ClassTabNavigationTests::moreThanSixClassesUseOrderedGradeGroups()
{
    ...
    QCOMPARE(
        static_cast<int>(model.mode),
        static_cast<int>(ClassTabNavigation::Mode::GradeGrouped)
        );
...
void ClassTabNavigationTests::gradeModeLabelsUseLevelAndSchedule()
{
...
void ClassTabNavigationTests::classTabsSortByLevelThenDay()
{
    QList<ClassTabNavigation::ClassEntry> entries{
        classEntry(
            1,
...
void ClassTabNavigationTests::duplicateLabelsAreDisambiguated()
{
    const QList<ClassTabNavigation::ClassEntry> entries{
        classEntry(
            1,
...
#include "class_tab_navigation_model_tests.moc"
