...
Phase 3 is complete: items 1–10 each have a dedicated sequence commit, and
...
Phase 2 remains in progress; the retained macOS repair is complete, while
DataService-facade retirement and the CI/device-owned Linux lane are active
closure work. The Qt-free engine already
