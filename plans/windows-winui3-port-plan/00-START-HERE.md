...
assembly, AI prompt rules, template policy, batch-export policy, PowerPoint
  ...
  speaking-evaluation grid validation, report batch ZIP archive writing, and the sub-prep package-planning,
