...
- **2026-08-31 — Roster persistence extracted.** The Qt-free `RosterService`
  ...
  filtering, and transactional rollback. The retained Qt repository remains
  an adapter boundary while the data path is connected to the engine service.
  Its focused test passed in all four x64/x86 Debug/Release WinUI lanes. Phase
  2 remains open for the remaining report/export adapter/model migration and
  broader per-slice fixture coverage.
