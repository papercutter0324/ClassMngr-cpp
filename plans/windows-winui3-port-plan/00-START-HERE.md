...
| [Phase 3 — WinUI application foundation](phase-3-winui-application-foundation.md) | **In progress** | Items 1–6 are committed; item 7 dialogs and dirty-state handling is the next gate. |
...
dirty-state handling is the next gate. Phase 1 is complete and
