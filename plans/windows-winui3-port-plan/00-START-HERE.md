...
| [Phase 3 — WinUI application foundation](phase-3-winui-application-foundation.md) | **In progress** | Items 1–5 are committed; item 6 Windows adapters is the next gate. |
...
Phase 3 is in progress: items 1–5 are committed, and item 6 Windows adapters
is the next gate. Phase 1 is complete and
