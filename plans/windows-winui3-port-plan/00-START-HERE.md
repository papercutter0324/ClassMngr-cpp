...
| [Phase 3 — WinUI application foundation](phase-3-winui-application-foundation.md) | **In progress** | Items 1–3 are committed; item 4 resource dictionaries and theme tokens are the next gate. |
...
Phase 3 is in progress: items 1–3 are committed, and item 4 resource
dictionaries and theme tokens are the current gate. Phase 1 is complete and
