...
| [Phase 3 — WinUI application foundation](phase-3-winui-application-foundation.md) | **In progress** | Item 1 lifecycle foundation is implemented; continue the ordered application-foundation sequence. |
