...
preview and apply workflows through the engine service too. The next active
gate is connecting the remaining retained adapters, while extending fixture
evidence across each migrated persistence slice.
