...
- **2026-09-08 — Phase 5 first-navigation gate measured.** The dedicated
  ...
  retains the 20 raw application results. Phase 5 remains in progress only for
  the Qt-derived table-parity handoff.
...
- **2026-09-08 — Phase 5 owner decisions and table handoff recorded.** The
  ...
  remains in progress until the handoff reconciliation is accepted; the
  navigation measurement is now recorded separately above.
