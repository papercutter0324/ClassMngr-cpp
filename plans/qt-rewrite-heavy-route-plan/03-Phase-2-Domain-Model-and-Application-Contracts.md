...
coverage. Decide whether the query merits a generic Application contract and
Platform adapter or can reuse a tested port before implementation. Workbook
